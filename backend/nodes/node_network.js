...
const { CombineMeshNode, PreviousNoteMeshNode, CubeNode, SphereNode, PlaneNode, CylinderNode, CustomMeshNode } = require('./mesh_nodes.js');
...
const NODE_MENU = {
	"Geometry": ["Cube", "Sphere", "Plane", "Cylinder", "Custom Mesh", "Combine meshes", "Previous Note Mesh"],
